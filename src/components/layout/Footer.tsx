      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <motion.div
            ...
            className="sm:col-span-2 lg:col-span-5 flex flex-col items-start pr-0 lg:pr-8"
          >
            <Logo variant="dark" size="md" />

            <p className="mt-5 text-[15px] leading-relaxed text-ink/85 max-w-md font-normal">
              Nigeria&apos;s leading job discovery platform. Stay connected,
              explore verified job listings, and kickstart your career anywhere.
            </p>
            ...
            <div className="mt-6 flex items-center gap-3 p-2.5 px-4 rounded-2xl bg-white/15 border border-white/25 backdrop-blur-md shadow-xs transition-transform duration-200 hover:scale-[1.02]">
              ...
              <div className="text-xs">
                <span className="block text-ink/70 font-medium">
                  Quick Dial Subscription
                </span>
                <span className="text-sm font-black text-[#055A2B] tracking-wide">
                  *7098#
                </span>
              </div>
            </div>
